...
# Set up a logger for Loki errors
loki_logger = logging.getLogger("loki_logger")
loki_logger.setLevel(logging.ERROR)  # Only log errors


loki_error_handler = logging.FileHandler("loki_errors.log")
formatter = logging.Formatter("%(asctime)s - %(levelname)s - %(message)s")
loki_error_handler.setFormatter(formatter)
loki_logger.addHandler(loki_error_handler)
...
def setup_logger(job="MyLogger", component="my_component",service="my_service", log_file="logs.txt"):
