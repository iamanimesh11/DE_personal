...
from python_Files.loki_request_python import fetch_job_ids, fetch_logs
...
selected_job= st.sidebar.selectbox("select job ids",job_ids) if job_ids else st.sidebar.warning("no job found")
